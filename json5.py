...
class _Parser:
    ...
    def _s_object_1(self):
        ...
        if self._failed:
            return
        self._o_succeed(self._fn_dict(v__2), self._pos)
    ...
    def _s_object_2(self):
        ...
        if self._failed:
            return
        self._o_succeed(self._fn_dict([]), self._pos)
    ...
    def _s_num_literal_1(self):
        ...
        if self._failed:
            return
        self._o_succeed(0 - v__2, self._pos)
    ...
    def _s_num_literal_3(self):
        ...
        if self._failed:
            return
        self._o_succeed(self._fn_atof(v__1), self._pos)
    ...
    def _s_num_literal_5(self):
        ...
        if self._failed:
            return
        self._o_succeed(self._fn_atoi(v__1, 16), self._pos)

    def _s_num_literal_6(self):
        self._o_str('Infinity')
        if self._failed:
            return
        self._o_succeed('Infinity', self._pos)

    def _s_num_literal_7(self):
        self._o_str('NaN')
        if self._failed:
            return
        self._o_succeed('NaN', self._pos)
