...
class Parser:
    ...
    def _grammar_s0_l_p_g_s1_(self):
    ...
    def _comment_c0_s1_(self):
        self._star(self._comment_c0_s1_p_)

    def _comment_c0_s1_p_(self):
    ...
    def _comment_c0_s1_p_g_s0_n_(self):
        self._eol_()

    def _comment_c0_s1_p_g_s1_(self):
        self._any_()
    ...
    def _comment_c1_s1_(self):
        self._star(self._comment_c1_s1_p_)

    def _comment_c1_s1_p_(self):
    ...
    def _comment_c1_s1_p_g_s0_n_(self):
        self._str('*/')

    def _comment_c1_s1_p_g_s1_(self):
        self._any_()

    def _comment_c1_s2_(self):
        self._str('*/')
    ...
    def _pragma_c0_s1_(self):
        self._bind(self._pragma_c0_s1_l_, 'is')
    ...
    def _pragma_c1_s2_(self):
        self._bind(self._pragma_c1_s2_l_, 'i')
    ...
    def _pragma_c2_s2_(self):
        self._bind(self._pragma_c2_s2_l_, 'i')
    ...
    def _pragma_c3_s2_(self):
        self._ch('=')

    def _pragma_c3_s3_(self):
        self._sp_()

    def _pragma_c3_s4_(self):
        self._bind(self._pragma_c3_s4_l_, 'cs')
    ...
    def _pragma_c4_s2_(self):
        self._bind(self._pragma_c4_s2_l_, 'c')
    ...
    def _pragma_c5_s2_(self):
        self._ch('=')

    def _pragma_c5_s3_(self):
        self._sp_()

    def _pragma_c5_s4_(self):
        self._bind(self._pragma_c5_s4_l_, 'cs')
    ...
    def _pragma_c6_s2_(self):
        self._bind(self._pragma_c6_s2_l_, 'o')

    def _pragma_c6_s2_l_(self):
        self._op_()

    def _pragma_c6_s3_(self):
        self._sp_()

    def _pragma_c6_s4_(self):
        self._bind(self._pragma_c6_s4_l_, 'd')
    ...
    def _pragma_c7_s1_(self):
        self._bind(self._pragma_c7_s1_l_, 'os')

    def _pragma_c7_s1_l_(self):
        self._plus(self._pragma_c7_s1_l_p_)

    def _pragma_c7_s1_l_p_(self):
    ...
    def _pragma_c7_s1_l_p_g_s0_(self):
        self._not(self._pragma_c7_s1_l_p_g_s0_n_)

    def _pragma_c7_s1_l_p_g_s0_n_(self):
        self._eol_()

    def _pragma_c7_s1_l_p_g_s1_(self):
        self._ws_()

    def _pragma_c7_s1_l_p_g_s2_(self):
        self._bind(self._pragma_c7_s1_l_p_g_s2_l_, 'o')

    def _pragma_c7_s1_l_p_g_s2_l_(self):
        self._op_()

    def _pragma_c7_s1_l_p_g_s3_(self):
    ...
    def _ident_list_s0_l_p_g_s1_(self):
        self._bind(self._ident_list_s0_l_p_g_s1_l_, 'i')
    ...
    def _ident_list_s0_l_p_g_s3_(self):
        self._not(self._ident_list_s0_l_p_g_s3_n_)

    def _ident_list_s0_l_p_g_s3_n_(self):
        self._ch('=')

    def _ident_list_s0_l_p_g_s4_(self):
    ...
    def _rule_s4_(self):
        self._bind(self._rule_s4_l_, 'cs')
    ...
    def _rule_s6_(self):
        self._opt(self._rule_s6_p_)

    def _rule_s6_p_(self):
        self._ch(',')
    ...
    def _ident_s1_l_(self):
        self._star(self._ident_s1_l_p_)

    def _ident_s1_l_p_(self):
        self._id_continue_()
    ...
    def _id_start_c2_(self):
        self._ch('_')

    def _id_start_c3_(self):
        self._ch('$')
    ...
    def _choice_s1_l_p_g_s1_(self):
        self._ch('|')

    def _choice_s1_l_p_g_s2_(self):
        self._sp_()

    def _choice_s1_l_p_g_s3_(self):
        self._seq_()
    ...
    def _seq_c0_s1_l_p_g_s1_(self):
        self._sp_()

    def _seq_c0_s1_l_p_g_s2_(self):
        self._expr_()
    ...
    def _expr_c0_s2_(self):
        self._bind(self._expr_c0_s2_l_, 'l')
    ...
    def _post_op_c1_(self):
        self._ch('*')

    def _post_op_c2_(self):
        self._ch('+')
    ...
    def _prim_expr_c0_s3_(self):
        self._sp_()

    def _prim_expr_c0_s4_(self):
        self._bind(self._prim_expr_c0_s4_l_, 'j')
    ...
    def _prim_expr_c3_s1_n_g_s1_(self):
        self._ch('=')
    ...
    def _prim_expr_c4_s2_(self):
        self._bind(self._prim_expr_c4_s2_l_, 'e')
    ...
    def _prim_expr_c5_s2_(self):
        self._bind(self._prim_expr_c5_s2_l_, 'e')

    def _prim_expr_c5_s2_l_(self):
        self._ll_expr_()

    def _prim_expr_c5_s3_(self):
        self._sp_()

    def _prim_expr_c5_s4_(self):
        self._ch('}')
    ...
    def _prim_expr_c6_s1_(self):
        self._bind(self._prim_expr_c6_s1_l_, 'e')
    ...
    def _prim_expr_c7_s2_(self):
        self._bind(self._prim_expr_c7_s2_l_, 'e')

    def _prim_expr_c7_s2_l_(self):
        self._ll_expr_()

    def _prim_expr_c7_s3_(self):
        self._sp_()

    def _prim_expr_c7_s4_(self):
        self._ch(')')
    ...
    def _prim_expr_c8_s2_(self):
        self._bind(self._prim_expr_c8_s2_l_, 'e')

    def _prim_expr_c8_s2_l_(self):
        self._ll_expr_()

    def _prim_expr_c8_s3_(self):
        self._sp_()

    def _prim_expr_c8_s4_(self):
        self._ch('}')
    ...
    def _prim_expr_c9_s2_(self):
        self._bind(self._prim_expr_c9_s2_l_, 'e')

    def _prim_expr_c9_s2_l_(self):
        self._choice_()

    def _prim_expr_c9_s3_(self):
        self._sp_()

    def _prim_expr_c9_s4_(self):
        self._ch(')')
    ...
    def _lit_c0_s1_(self):
        self._bind(self._lit_c0_s1_l_, 'cs')

    def _lit_c0_s1_l_(self):
        self._star(self._lit_c0_s1_l_p_)

    def _lit_c0_s1_l_p_(self):
        self._sqchar_()

    def _lit_c0_s2_(self):
        self._squote_()
    ...
    def _lit_c1_s1_(self):
        self._bind(self._lit_c1_s1_l_, 'cs')

    def _lit_c1_s1_l_(self):
        self._star(self._lit_c1_s1_l_p_)

    def _lit_c1_s1_l_p_(self):
        self._dqchar_()

    def _lit_c1_s2_(self):
        self._dquote_()
    ...
    def _sqchar_c0_s1_(self):
        self._bind(self._sqchar_c0_s1_l_, 'c')

    def _sqchar_c0_s1_l_(self):
        self._esc_char_()

    def _sqchar_c0_s2_(self):
    ...
    def _dqchar_c0_s1_(self):
        self._bind(self._dqchar_c0_s1_l_, 'c')

    def _dqchar_c0_s1_l_(self):
        self._esc_char_()

    def _dqchar_c0_s2_(self):
        self._succeed(self._get('c'))
    ...
    def _hex_esc_s1_(self):
        self._bind(self._hex_esc_s1_l_, 'h1')

    def _hex_esc_s1_l_(self):
        self._hex_()

    def _hex_esc_s2_(self):
        self._bind(self._hex_esc_s2_l_, 'h2')
    ...
    def _escape_s1_(self):
        self._bind(self._escape_s1_l_, 'i')

    def _escape_s1_l_(self):
        self._ident_()

    def _escape_s2_(self):
        self._ch('}')
    ...
    def _ll_exprs_c0_s1_l_p_g_s1_(self):
        self._ch(',')

    def _ll_exprs_c0_s1_l_p_g_s2_(self):
        self._sp_()

    def _ll_exprs_c0_s1_l_p_g_s3_(self):
        self._ll_expr_()
    ...
    def _ll_expr_c0_s3_(self):
        self._sp_()

    def _ll_expr_c0_s4_(self):
        self._bind(self._ll_expr_c0_s4_l_, 'e2')
    ...
    def _ll_expr_c1_s3_(self):
        self._sp_()

    def _ll_expr_c1_s4_(self):
        self._bind(self._ll_expr_c1_s4_l_, 'e2')
    ...
    def _ll_qual_c0_s1_l_(self):
        self._plus(self._ll_qual_c0_s1_l_p_)

    def _ll_qual_c0_s1_l_p_(self):
        self._ll_post_op_()
    ...
    def _ll_post_op_c0_s2_(self):
        self._bind(self._ll_post_op_c0_s2_l_, 'e')

    def _ll_post_op_c0_s2_l_(self):
        self._ll_expr_()

    def _ll_post_op_c0_s3_(self):
        self._sp_()

    def _ll_post_op_c0_s4_(self):
        self._ch(']')
    ...
    def _ll_post_op_c1_s2_(self):
        self._bind(self._ll_post_op_c1_s2_l_, 'es')

    def _ll_post_op_c1_s2_l_(self):
        self._ll_exprs_()

    def _ll_post_op_c1_s3_(self):
        self._sp_()

    def _ll_post_op_c1_s4_(self):
        self._ch(')')
    ...
    def _ll_prim_c6_s1_(self):
        self._bind(self._ll_prim_c6_s1_l_, 'hs')
    ...
    def _ll_prim_c9_s2_(self):
        self._bind(self._ll_prim_c9_s2_l_, 'e')

    def _ll_prim_c9_s2_l_(self):
        self._ll_expr_()

    def _ll_prim_c9_s3_(self):
        self._sp_()

    def _ll_prim_c9_s4_(self):
        self._ch(')')
    ...
    def _ll_prim_c10_s2_(self):
        self._bind(self._ll_prim_c10_s2_l_, 'es')

    def _ll_prim_c10_s2_l_(self):
        self._ll_exprs_()

    def _ll_prim_c10_s3_(self):
        self._sp_()

    def _ll_prim_c10_s4_(self):
        self._ch(']')
    ...
    def _digits_s0_l_(self):
        self._plus(self._digits_s0_l_p_)

    def _digits_s0_l_p_(self):
        self._digit_()
    ...
    def _hexdigits_s0_l_(self):
        self._plus(self._hexdigits_s0_l_p_)

    def _hexdigits_s0_l_p_(self):
        self._hex_()
