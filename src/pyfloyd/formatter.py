...
class FormatObj:
    ...
    def as_list(self):
        return [self.tag] + [as_list(obj) for obj in self.objs]

    def as_lisplist(self):
        assert self.tag is not None
        return LispList([self.tag] + [as_lisplist(obj) for obj in self.objs])
