...
class PythonGenerator(Generator):
    ...
    def generate(self) -> str:
        if self._options.main:
            text = self._gen_main_header(
                self._options.version, self._options.args
            )
        else:
            text = self._gen_default_header(
                self._options.version, self._options.args
            )
        ...
        text += self._gen_result_class()
        text += '\n\n'
        text += self._gen_parse_function()
        text += '\n\n'
    ...
    def _gen_main_header(self, version, args):
    ...
    def _gen_default_header(self, version, args):
        imports = self._gen_imports()
        return self._dedent("""\
            # Generated by pyfloyd version {version}
            #    https://github.com/dpranke/pyfloyd
    ...
    def _gen_result_class(self) -> str:
        return self._dedent("""\
    ...
    def _gen_parse_function(self) -> str:
        return self._dedent("""\
            def parse(
    ...
    def _gen_methods(self) -> str:
        vobj = VList([])
        vobj.append(self._gen_parse_method(
