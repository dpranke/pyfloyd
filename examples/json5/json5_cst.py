...
#
#    `flc --tokenize -o json5_cst.py grammars/json5.g`
#
...
class _Parser:
    ...
    def _s_object_2(self):
        ...
        if self._failed:
            return
        self._o_succeed(
            self._externs['node'](self, self._externs['dict'](v__2)), self._pos
        )
    ...
    def _s_object_3(self):
        ...
        if self._failed:
            return
        self._o_succeed(
            self._externs['node'](self, self._externs['dict']([])), self._pos
        )
    ...
    def _s_array_3(self):
        ...
        if self._failed:
            return
        self._o_succeed(self._externs['node'](self, []), self._pos)
